...
export async function addConnection(
  ...
  try {
    ...
    if (tagResult.wasAutoGenerated) {
      console.log(chalk.blue(`ℹ️  No tag provided. Auto-generated tag '${finalTag}'.`));
    ...
    if (tagResult.wasAutoGenerated && !tagResult.wasConflictResolved) {
      console.log(
        chalk.dim(
          `\nℹ️  Future tip: You can specify a custom tag like: schiba add myapp "${connectionString}"`
        )
      );
    }
  } catch (error) {
